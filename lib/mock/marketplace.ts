...
export const mockVendorProfiles: MockVendorProfile[] = [
  {
    ...
    tagline: 'Full-service install and maintenance across Muscat & Batinah',
    yearsActive: 4,
    sitesInstalled: 38,
    rating: 4.7,
    coverageCities: ['Muscat', 'Barka', 'Sohar', 'Salalah', 'Sur', 'Seeb'],
  ...
  },
  {
    ...
    sitesInstalled: 14,
    rating: 4.5,
    coverageCities: ['Sohar', 'Muscat'],
    responseTime: '48-hour site survey',
  },
  {
    id: 'vnd-northgrid',
    name: 'NorthGrid EV',
    tagline: 'Highway corridor specialists',
    yearsActive: 3,
    sitesInstalled: 22,
    rating: 4.6,
    coverageCities: ['Nizwa', 'Seeb', 'Duqm'],
...
export const mockVendorPackages: MockVendorPackage[] = [
  ...
  },
  {
    ...
    priceInPkr: 7800,
    turnaroundDays: 35,
    description: 'Single high-power unit built for highway service areas.',
  },
];
